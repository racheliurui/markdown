...
types of instances,
1) general purpose: fixed performance (M5, M4) or burstable performance (T2)
2) compute optimized : (C5, C4)
3) memery optimized: (X1e, X1, R4)
  * 适合sap hana，big data；Spark, presto
4) GPU (Accelerating Computing instances): (P3, P2, G3, F1) (G3)
